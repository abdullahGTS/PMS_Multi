...
class FooterPresetValue extends StatelessWidget {
  ...
  var listenerGetNextTransactionSequenceNo;
              ...
              GestureDetector(
                  onTap: () async {
                    ...
                    if (int.parse(presalecontroller.value) >= 10 &&
                        int.parse(presalecontroller.value) < 10000 &&
                      ...
                      listenerGetNextTransactionSequenceNo =
                        ...
                        if (serviceResponse != null) {
                          ...
                          if (RequestType == 'GetNextTransactionSequenceNo' &&
                            ...
                            await presalecontroller.saveTrxStatus();
                            listenerGetNextTransactionSequenceNo!.cancel();
