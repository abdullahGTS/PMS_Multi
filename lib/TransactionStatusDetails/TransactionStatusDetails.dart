...
import '../Footer/Footer_TrxStatusDetails.dart';
import '../Local/Local_Controller.dart';
import '../Theme/Theme_Controller.dart';
import 'TransactionStatusDetails_Controller.dart';

class TransactionStatusDetails extends StatelessWidget {
  TransactionStatusDetails({super.key});
  final availabletrxdetailsController =
      Get.find<TransactionStatusDetailsController>();
        ...
        return Scaffold(
          ...
          body: Obx(() {
            ...
            return SingleChildScrollView(
              child: availabletrxdetailsController.isLoading.value
                  ? Column(
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(
                                      height:
                                          15), // Space between AppBar and content
                                  // Total Amount Card
                                  Container(
                                    ...
                                    child: Card(
                                      color:
                                          const Color(0xFF166E36), // Card color
                                      child: Padding(
  ...
  Widget _buildPaymentOption(
      ...
      TransactionStatusDetailsController paymentController,
      String title,
      IconData icon) {
    return Obx(() {
            ...
            children: [
              ...
              Expanded(
                ...
                child: Text(
                  title,
                  style: TextStyle(
                    fontSize: 20, color: fontColor, // White text color
                  ),
                ),
              ),
            ],
