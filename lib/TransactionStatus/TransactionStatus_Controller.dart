...
class TransactionStatusController extends GetxController {
  ...
  GetAllTransaction(pumpName) async {
...
''';
        ...
        if (RequestType == 'GetAvailableFuelSaleTrxs' &&
          ...
          allClasses.forEach((element) {
            ...
            if (errorCode == 'ERRCD_OK') {
              bool transactionExists = AvailableTrxTempList.any((transaction) =>
                  transaction['TransactionSeqNo'] == TransactionSeqNo);
    ...
    // Sort the list in descending order by TransactionSeqNo
    ...
    if (AvailableTrxTempList.isNotEmpty) {
      AvailableTrxList.add(AvailableTrxTempList);
    }
    // AvailableTrxList.value = AvailableTrxTempList;
    print("AvailableTrxList--${AvailableTrxList.value}--");
  ...
  TransactionDetails(TrxSeqNo) {
    ...
    Get.toNamed('/TransactionStatusDetails', arguments: {'TrxSeqNo': TrxSeqNo});
    AvailableTrxList.value = [];
  }
...
//   getTrxStatus(pumpNo) async {
//     print("getTrxStatus${pumpNo}");
//     TrxDetailsList.value = await dbHelper.getTrxStatus(pumpNo);
//     print("STATtusTrans${TrxDetailsList.value}");
//   }
}
